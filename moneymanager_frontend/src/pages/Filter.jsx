    ...
    return (
        <Dashboard activeMenu="Filters">
            <div className="my-5 mx-auto">
                ...
                <div className="card p-4 mb-4 bg-gray-200 shadow-lg">
                    ...
                    <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        ...
                        <div>
                            <label htmlFor="endtdate" className="block text-sm font-medium mb-1">End Date</label>
                            <input value={endDate} id="senddate" type="date" className="w-full border rounded px-3 py-2" onChange={e => setEndDate(e.target.value)} />
                        </div>
                        <div>
                ...
                <div className="card p-4">
                    ...
                    {transactions.length === 0 && !loading ? (
                        <p className="text-gray-500">Select the filters and click appy to filter the transactions</p>
                    ) : ""}
                    {loading ? (
